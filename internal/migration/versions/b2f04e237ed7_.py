...
Revision ID: b2f04e237ed7
Revises: c889319bf828
Create Date: 2025-05-22 23:53:27.762774
...
revision = 'b2f04e237ed7'
down_revision = 'c889319bf828'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('account_oauth', schema=None) as batch_op:
        ...
        batch_op.create_index('account_oauth_openid_provider_idx', ['provider'], unique=False)
